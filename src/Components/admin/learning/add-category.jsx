...
const AddCategory = ({ handleSubmit, category, isLearning }) => {
  ...
  const formik = useFormik({
    ...
    validationSchema: Yup.object({
      ...
      nameEn: Yup.string().max(255).required("Названеи en обязательное поле"),
      slug: Yup.string().max(255).required("Ссылка обязательное поле"),
    }),
    onSubmit: async ({ nameRu, nameUz, nameEn, slug }) => {
